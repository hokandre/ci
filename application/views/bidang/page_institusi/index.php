...
<html lang="en">
    <?php $this->load->view('template/header.php',[
        "page_title" => "Dashboard Bidang Institusi"
    ]);?>
<body>
        ...
        <section class="page-content" id="page-dashboard-bidang">
            <?php 
                $this->load->view('template/content_title.php',[
                    "element" => $this->load->view('bidang/page_institusi/ct_element.php','',TRUE),
                    "toolbar" => $this->load->view('bidang/page_institusi/ct_toolbar.php','', TRUE)
                ]);
            ?>
            <div class="flex-row">
                <!-- pie chart -->
                ...
                <div class="flex-col-6">
                    <?php 
                        $this->load->view('template/line_chart.php',[
                            "action" => $data_aksi["action_lihat_bidang_institusi"],
                            "custom_variabel" => $this->load->view("bidang/page_institusi/form_variabel.php", '', TRUE)
                        ]);
                    ?>
                </div>
            </div>
            ...
            <?php
                $this->load->view('template/table_filter.php',[
                    "table" => $this->load->view("bidang/page_institusi/table_unit.php",'', TRUE)
                ]);
            ?>
...
let chartDetilKinerja = drawBarChartDetilKinerjaInstitusi(canvasDetilKinerjaSaatIni, dataDetilKinerjaSaatIni, { keteranganPeriode : keteranganPeriode });
