...
<html lang="en">
    <?php $this->load->view('template/header.php',[
        "page_title" => "Dashboard Bidang User"
    ]);?>
<body>
        ...
        <section class="page-content" id="page-dashboard-bidang">
            <?php 
                $this->load->view('template/content_title.php',[
                    "element" => $this->load->view('bidang/page_user/ct_element.php','',TRUE),
                    "toolbar" => $this->load->view('bidang/page_user/ct_toolbar.php','', TRUE)
                ]);
            ?>
                ...
                <div class="flex-col-6">
                    <?php 
                        $this->load->view('template/line_chart.php',[
                            "action" => $data_aksi["action_lihat_bidang_user"],
