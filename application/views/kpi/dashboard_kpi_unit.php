        ...
        <div class="flex-row">
            ...
            <div class="flex-col-6">
                <div class="card">
                    ...
                    <h4><i class="fas fa-tachometer-alt"></i> 
                        Pencapaian kpi  Unit Periode (<?=$keteranganperiode;?>)
                    </h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="flex-col-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="ubah-periode" action="<?=$action_lihat_kpi_unit;?>" method="post">
                            <!-- for bread crumb -->
                    ...
                    <tbody>
                        <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form id="lihat-user" action="<?=$action_lihat_kpi_user;?>" method="post">
...
$(document).on('change', 'select[name="unit_id"]', function(){
    let ketuaUnit = $(this).find(":selected").attr("ketua-unit");
    ...
    $('#ubah-unit').find('input[name="ketua_unit"]').val(ketuaUnit);
    $('#ubah-unit').submit();
})
...
let myBarChartDetilKinerjaSaatIni = new Chart(canvasDetilKinerjaSaatIni, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: dataDetilKinerjaSaatIni.map(el =>{
                let persenKetercapaian = (el.nilai_pencapaian / el.MAX_SCORE) * 100  
                return persenKetercapaian > 100 ? 100 : persenKetercapaian;
            }) ,
            ...
            callbacks : {
                label: function(tooltipItem, data) {
                    ...
                    return [
                        ...
                        `(${(dataDetilKinerjaSaatIni[tooltipItem.index].nilai_pencapaian / dataDetilKinerjaSaatIni[tooltipItem.index].MAX_SCORE) * 100}%)`
                    ];
                }
            }
      }
